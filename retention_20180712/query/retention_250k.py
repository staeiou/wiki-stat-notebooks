import pandas as pd
editors = pd.read_csv('user_reg_with_userpages_250k.tsv', delimiter='\t', infer_datetime_format=True)
...
for index, row in editors.iterrows():
    ...
    query += """ " >> /home/staeiou/wiki-stat-notebooks/retention_20180712/query/retention_250k.tsv  """ 
    print(query)
